    ...
    <center>
        ...
        ?>
                <form action="edit_jurusan.php" method="POST">
                    <input type="hidden" name="id_jurusan" value="<?php echo
                                                                    $ed_id_jurusan ?>"> Nama Jurusan :
                    <input type="text" name="nama_jurusan" value="<?php echo
                                                                    $ed_nama_jurusan ?>">
                    <br><br>
        ...
        <table cellpadding="2" cellspacing="0" border="1">
            ...
            <tbody>
                <?php
                $sql = mysql_query("select * from tb_jurusan order by id_jurusan
...
width='150'>" . $row['nama_jurusan'] . "</td>
<td><a href='edit_jurusan.php?id_jurusan=" . $row['id_jurusan'] . "'>Edit
</a></td>
</tr>
";
                    $no++;
